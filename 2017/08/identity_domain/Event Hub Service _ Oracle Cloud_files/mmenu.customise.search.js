(function($) {
					...
					$wrapper.each(
						function() {
							...
							if (!$panl.children(_node + '.' + _c.search).length) {
						        ...
						        if (opts.siteidInPath=='true'){
									$node.append('<form id="mMenuSearchForm" action="'+opts.formActionPage+'">'+
											'<div class="">'+
												'<div class="mm-searchfield-input-block">'+
													'<input placeholder="' + opts.placeholder + '" type="text" user-scalable=0 name="queryStr" autocomplete="off" maxlength="128" />'+
												'</div>'+
										        '<div class="mm-searchfield-icon-block">'+
										        	'<div class="mm-searchfield-icon">'+
										        	'</div>'+
										        '</div>'+
									        '</div>'+
											'<div class="">'+
									    			'<input type="radio" class="mm-searchfield-indicator-radio" name="scope" value="0" checked>'+
									    				'<span class="p3 mm-searchfield-indicator-text-block"  title="'+opts.searchCloudOnlyText +'">'+
									    					opts.searchCloudOnlyText +
									    				 '</span>'+
									    			'</input>'+
									    	'</div>'+
									    	'<div>'+
									    			'<input type="radio" class="mm-searchfield-indicator-radio" name="scope" value="1">'+
									    				'<span class="p3 mm-searchfield-indicator-text-block" title="'+opts.searchAllOracleText+'">'+
									    					opts.searchAllOracleText +
									    				'</span>'+
									    			'</input>'+
									        '</div>'+
									      '</form>');	
									...
									$node.append('<form id="mMenuSearchForm" action="'+opts.formActionPage+'">'+
									    	...
									    	'<div>'+
									    			...
									    			'</input>'+
									        '</div>'+
											'<input type=hidden name="siteid" value="'+opts.siteid+'">'+
									      '</form>');
	...
	$[_PLUGIN_].defaults[_ADDON_] = {
		...
		//showLinksOnly	: true,
        siteid:'en_US',
        searchCloudOnlyText:'cloud.oracle.com only',
        searchAllOracleText:'search.oracle.com',
        siteidInPath:'',
